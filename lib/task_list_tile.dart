...
class _TaskListTileState extends State<TaskListTile> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border.all(color: const Color.fromARGB(255, 0, 92, 150)),
              ...
              children: widget.task.items.asMap().entries.map((entry) {
                ...
                return ListTile(
                  ...
                  leading: Checkbox(
                    ...
                    activeColor: const Color.fromARGB(255, 76, 125, 175),
                  ),
                  title: Text(
                    taskItem.text,
                    style: TextStyle(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        icon: Icon(Icons.edit, color: const Color.fromARGB(255, 202, 177, 32)),
                        onPressed: () {
                          _showEditBottomSheet(context, itemIndex);
                        },
                      ),
                      IconButton(
                        icon: Icon(Icons.delete, color: const Color.fromARGB(255, 191, 188, 13)),
                        onPressed: () {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color.fromARGB(255, 0, 112, 150),
                          ),
                          child: Text(
                            '+',
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color.fromARGB(255, 0, 92, 150),
  ...
  Color _getTaskStatusColor(Task task) {
    ...
    if (completedTasks == 0) {
      ...
      return const Color.fromARGB(255, 76, 107, 175);
    } else {
