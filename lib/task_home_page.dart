...
class _TaskHomePageState extends State<TaskHomePage> {
  ...
  Color _getTaskStatusColor(Task task) {
    ...
    if (completedTasks == 0) {
      ...
      return const Color.fromARGB(255, 121, 115, 7); 
    } else {
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      formattedDate,
                      style: TextStyle(fontSize: 16, color: const Color.fromARGB(255, 17, 111, 188)),
                    ),
                    IconButton(
                      icon: Icon(Icons.calendar_today, color: const Color.fromARGB(255, 12, 136, 189)),
                      onPressed: () {
                        _selectDate(context);
                      },
                    ),
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 24, 142, 232),
